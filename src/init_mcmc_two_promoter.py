...
def bkwd_algorithm(init_vec, a_log, p_log, pi0_log):
    ...
    :param init_vec: a single time series of initiation event counts
    :param a_log: current estimate of transition probability matrix (KxK)
    :param p_log: current estimate of initiation probability matrix (3xK)
...
def empirical_counts(a_log, p_log, pi0_log, init_data, alpha_list, beta_list):
    ...
    :param p_log: Float array (3xK). Log of current estimate for emission matrix
...
def init_prom_mcmc(init_data, a_prior, p_prior, pi0_prior, n_steps=1000, burn_in=100):
    """
    :param init_data: list of lists. Each element is time series of initiation events
    :param a_prior: hyperparams for prior distribution over transition probability matrix (KxK)
    :param p_prior: prior hyperparams for distribution over initiation probability vector (2xK)
    :param pi0_prior: hyperparams for prior distribution over initial state PDF
